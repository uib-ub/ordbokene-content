...
Go to [pwa.ordbokene.no](https://pwa.ordbokene.no). You must be connected to the internet to complete the download.  
...
Check to delete data and click "Remove". Go to [pwa.ordbokene.no](https://pwa.ordbokene.no) and start over.
