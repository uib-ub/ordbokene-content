...
*   **Chrome**<img alt="Chrome logo" src="https://api.iconify.design/logos:chrome.svg">
    1. Select the icon with the three vertical dots in the upper right corner of the browser: <img alt="icon" src="https://api.iconify.design/bi:three-dots-vertical.svg" width="24" height="24">
    2. A list of options appears. Select "Add to home page", a little down the list: <img alt="icon" src="https://api.iconify.design/material-symbols:add-to-home-screen.svg" width="24" height="24">
