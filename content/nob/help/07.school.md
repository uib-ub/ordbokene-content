...
Udir anbefaler at elever og privatister i forkant av eksamen laster ned en versjon av aktuelle ordbøker på de enhetene som skal brukes på eksamensdagen. Via nettsida [pwa.ordbokene.no](https://pwa.ordbokene.uib.no) kan du nå laste ned en versjon av _Bokmålsordboka_ og _Nynorskordboka_, som du kan bruke uten å være på nett. Denne appen fungerer på samme måte som nettsida, med unntak av at fritekstsøket ikke er tilgjengelig.
...
Gå til [pwa.ordbokene.no](https://pwa.ordbokene.uib.no). Du må være koblet til nett for å gjennomføre nedlastingen. 
