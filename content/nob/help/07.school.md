...
Merk at den nedlastbare versjonen ennå ikke er tilgjengelig for mobiler og i nettleserne Firefox og Safari. Under gjør vi rede for hvordan du laster ned appen i Chrome og Microsoft Edge. Brukere av Apple-produkter, som Mac, må bruke nettleseren Chrome.

### Slik laster du ned appen i Chrome ![Chrome logo](/content-images/logos_chrome.svg)
Gå til [pwa.ordbokene.no](https://pwa.ordbokene.no). Du må være koblet til nett for å gjennomføre nedlastingen. 
...
![Nedlastingsinformasjon i dialogboks](/content-images/Downloading_symbol_nob.png)

Appen legger seg på oppgavelinja på skjermen din. I noen tilfeller må du tillate det først.

Åpn og lukk appen en gang for å være sikker på at den senere åpner seg i offline-modus.
